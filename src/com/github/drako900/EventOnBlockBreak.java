...
public class EventOnBlockBreak {
    ...
    if(checkedtrue==true){
    	...
    	if(cant_destroy==false && event.getBlock().getType()==Material.WALL_SIGN || cant_destroy==false && event.getBlock().getType()==Material.SIGN_POST){
    	
    		if(sign4[0].equalsIgnoreCase("AllBanks")||sign4[0].equalsIgnoreCase("All Banks")||sign4[0].equalsIgnoreCase("[AllBanks]")){
